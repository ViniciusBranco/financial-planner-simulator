    ...
    def __init__(self, model_name: str = "qwen2.5:7b", base_url: str = "http://host.docker.internal:11434"):
        ...
        self.prompt = ChatPromptTemplate.from_messages([
            ("system", 
             ...
             "\n"
             "**Logic for Food (Mercado vs Restaurante vs Delivery):**\n"
             "- If description contains terms like 'iFood', 'Rappi', 'Uber Eats', 'Zé Delivery', classify as 'Delivery'.\n"
             "- If description suggests supermarkets, wholesale, or butchers (e.g., 'Carrefour', 'Pão de Açúcar', 'Tenda', 'Atacadão', 'Açougue', 'Hortifruti'), classify as 'Mercado'.\n"
             "- If description suggests physical dining, bakeries, coffee shops, or fast food (e.g., 'Padaria', 'McDonalds', 'Outback', 'Restaurante'), classify as 'Restaurante'.\n"
             "- Use 'Alimentação' ONLY if it is clearly food-related but ambiguous between the three above.\n"
             "\n"
